...
export const PRODUCTS: Product[] = [
  // WORKING TABLES & BENCHES
  {
    ...
    shortHook: "Heavy-duty Mild Steel working tables designed for demanding industrial environments.",
    description: "Our MS Working Tables are engineered for durability and stability. Built with high-grade mild steel, these tables are perfect for assembly lines, workshops, and heavy fabrication units in Chennai. Features include a reinforced top, adjustable leveling feet, and a premium powder-coated finish for rust resistance.",
    specifications: {
  ...
  },
  {
    ...
    shortHook: "Lightweight yet incredibly strong nylon hand trolleys for effortless material movement.",
    description: "The Nylon Hand Trolley from Apex Engineering is a versatile material handling solution. Ideal for warehouses and labs, it offers a non-corrosive, non-marking, and silent operating experience. The high-grade nylon body ensures long-lasting performance even in humid conditions.",
    specifications: {
  ...
  },
  {
    ...
    category: "working-tables",
    shortHook: "Ergonomic, chemical-resistant workbenches for pharmaceutical and research laboratories.",
    description: "Designed specifically for lab environments, our Laboratory Workbenches feature S.S or high-pressure laminate tops that resist chemicals and spills. Built with vibration-dampening structures, these benches are perfect for precision tasks, microscopy, and chemical analysis in Chennai's growing pharma sector.",
    specifications: {
  ...
  },
  {
    ...
    category: "trolleys-carts",
    shortHook: "Customizable Lean Manufacturing trolleys built with high-strength ABS coated pipes.",
    description: "Our ABS Pipe Trolleys are the cornerstone of Lean Manufacturing. Using a system of ABS-coated pipes and joints, these trolleys are lightweight, modular, and can be reconfigured as your production needs change. Perfect for electronic assembly and light-duty material handling.",
    specifications: {
  ...
  },
  {
    ...
    shortHook: "Gravity and motorized roller conveyors for efficient production line transport.",
    description: "Apex Engineering's Roller Conveyors streamline your material flow. Available in gravity-fed or motorized variants, our conveyors are built with precision bearings and heavy-duty rollers to handle boxes, pallets, and crates with minimal effort.",
    specifications: {
